      ...
      <div class="full-width-split__two">
       ...
       // print_r($blogs);
        //die;
          ...
          <?php } ?>
         <p class="t-center no-margin"><a href="<?= site_url('/blogs')?>" class="btn btn--yellow">View All Blog Posts</a></p>
        </div>
      </div>
    </div>
...
<?php
$data = [
  ['title'=>'post1' , 'body'=>'content' , 'userID'=>1],
  ['title'=>'post2' , 'body'=>'content2' , 'userID'=>1],
];
//(json_encode($data));
